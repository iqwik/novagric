...
include_once TEMPLATEPATH . '/lib/common/index.php'; // общие методы
/******************************************* кастомные функции ********************************************************/
include_once TEMPLATEPATH . '/lib/_helpers/functions.php'; // вспомогательные методы
include_once TEMPLATEPATH . '/lib/pages/index.php'; // методы по страницам
/**************************************************** Ajax ************************************************************/
